...
const firstRow = Position.One;
const secondRow = Position.Two;
const thirdRow = Position.Three;
const firstColumn = Position.One;
const secondColumn = Position.Two;
const thirdColumn = Position.Three;
...
class Tile {
  private x: Position = Position.One;
  private y: Position = Position.One;
  ...
  constructor() {
    for (let x = firstRow; x <= thirdRow; x++) {
      for (let y = firstColumn; y <= thirdColumn; y++) {
        this._plays.push(new Tile(x as Position, y as Position, noPlayer));
      }
    }
  }
